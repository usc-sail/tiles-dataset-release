...
ax[0].hist(fitbit['hours'], label='Fitbit', color='tab:blue', bins=bins)
ax[0].set_xlim((0,24))
ax[0].set_ylabel('Participants')
ax[0].grid(which='major', axis='both')
ax[0].legend()

ax[1].hist(omsignal['hours'], label='OMsignal garments', color='tab:orange', bins=bins)
ax[1].set_xlim((0,24))
ax[1].set_ylabel('Participants')
ax[1].grid(which='major', axis='both')
ax[1].legend(loc='upper left')

ax[2].hist(owlinone['hours'], label="Jelly phones", color='tab:green', bins=bins)
ax[2].set_xlim((0,24))
